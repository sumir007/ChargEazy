...
function Csnearyou() {
  return (
    ...
    <div style={{ textAlign: 'center' }}>
      <h1 className='text-4xl mt-2 mb-8 text-black font-medium'>Charging Stations Nearby You</h1>
      ...
      <ul>
        ...
        <li>
        <span className='text-indigo-600 font-medium text-lg underline'><Link to='/stn1'>Ather Charging Grid</Link></span>
        </li>
        <li>
